 ...
 *
 * Note: 
 * only after writing this, the following has been found: https://community.bistudio.com/wiki/BIS_fnc_getCloudletParams
 *
 * Example:
 * ["CVO_PE_Leafes"] call cvo_storm_fnc_particle_get_params_from_config; - much faster then this funciton
 * 
 * Public: No
 */
